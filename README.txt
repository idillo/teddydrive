...
- Runtime buyer routing requires the verified BUYER_ROUTING_CONFIG_V2 deployment snapshot; missing, invalid, or empty routing stops delivery and records an explicit routing failure
