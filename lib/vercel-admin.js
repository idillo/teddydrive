...
async function publishRouting(buyers) {
  const safe = buyers.map(({ id, name, campaign_name, campaign_id, lead_type, source_code, terminating_phone, delivery_mode, adapter, environment, priority, direct_endpoint_url, ping_endpoint_url, post_endpoint_url, auth_env_var, auth_scheme, headers, timeout_ms }) => ({ id, name, campaign_name, campaign_id, lead_type, source_code, terminating_phone, delivery_mode, adapter, environment, priority, direct_endpoint_url, ping_endpoint_url, post_endpoint_url, auth_env_var, auth_scheme, headers, timeout_ms }));
...
module.exports = { tokenKey, saveBuyerToken, publishRouting };
