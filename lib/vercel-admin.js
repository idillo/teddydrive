...
async function publishRouting(buyers) {
  const safe = buyers.map(({ id, name, delivery_mode, adapter, environment, priority, direct_endpoint_url, ping_endpoint_url, post_endpoint_url, auth_env_var, auth_scheme, headers, timeout_ms }) => ({ id, name, delivery_mode, adapter, environment, priority, direct_endpoint_url, ping_endpoint_url, post_endpoint_url, auth_env_var, auth_scheme, headers, timeout_ms }));
